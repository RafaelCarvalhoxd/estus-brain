...
const TOOL_LABELS: Record<string, string> = {
  ...
  bills_pay: "Pagou uma conta",
  bills_mark_received: "Marcou conta como recebida",
  bills_unpay: "Desfez um pagamento",
  bills_update: "Editou uma conta",
  bills_end_series: "Encerrou uma repetição",
  bills_resume_series: "Retomou uma repetição",
  finance_create_category: "Criou uma categoria",
  finance_update_category: "Editou uma categoria",
  finance_delete_category: "Excluiu uma categoria",
  finance_create_credit_card: "Cadastrou um cartão",
  finance_update_credit_card: "Editou um cartão",
  finance_delete_credit_card: "Excluiu um cartão",
  finance_card_invoices: "Consultou as faturas",
  notes_update: "Editou uma nota",
  reminders_update: "Editou um lembrete",
  agenda_update: "Editou um compromisso",
  habits_list: "Consultou hábitos",
  habits_update: "Editou um hábito",
  habits_delete: "Excluiu um hábito",
